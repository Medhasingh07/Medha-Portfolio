...
export default function HeroSection() {
  return (
    <section id="home" className="relative w-full h-[85vh] min-h-[600px] flex items-center justify-center gradient-background">
      <div className="container mx-auto px-4 md:px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-lg font-medium text-primary sm:text-xl md:text-2xl font-headline">
